...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        current_values = mixed.calculate_power_values(period='current', latitude=latitude, longtitude=longitude)
        tomorrow_values = mixed.calculate_power_values(period='tomorrow', latitude=latitude, longtitude=longitude)
